...
class LearnerSignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
            ...
            for fieldname in ['username', 'password1', 'password2']:
                self.fields[fieldname].help_text = None #this is for removing warnings like must be 8 chr long, should have no and @ etc.
                
#this for saving a user who is learner
    @transaction.atomic 
    def save(self):
        user = super().save(commit=False)
